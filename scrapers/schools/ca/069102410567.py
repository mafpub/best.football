"""Deterministic athletics scraper for ACCESS County Community (CA)."""
...
NCES_ID = "069102410567"
SCHOOL_NAME = "ACCESS County Community"
STATE = "CA"
...
SEARCH_QUERIES = [
    ...
    "ACCESS County Community athletics",
    "ACCESS County Community sports",
]
...
def _keyword_lines(text: str, limit: int = 20) -> list[str]:
    ...
    for raw_line in text.splitlines():
        ...
        if (
            ...
            or "«access county community" in lowered
            or "\"access county community" in lowered
        ):
            continue
...
async def _collect_page_signals(page) -> dict[str, Any]:
    ...
    mentions_target_school = "access county community" in text_lower
    ...
    for link in links:
        ...
        if "access county community" in combo:
...
async def scrape_school() -> dict[str, Any]:
    ...
    async with async_playwright() as playwright:
        ...
        try:
            ...
            if await county_link.count() > 0:
                ...
                # Fallback direct page open keeps deterministic coverage.
            ...
            for query in SEARCH_QUERIES:
                ...
                if await search_input.count() > 0:
                    ...
                    # Fallback keeps query behavior deterministic if search widget changes.
    ...
    athletics_program_available = bool(all_athletics_lines or school_page_links)
    if not school_page_links:
