"""Deterministic athletics availability scraper for Alameda Science and Technology Institute (CA)."""
...
NCES_ID = "060177010547"
SCHOOL_NAME = "Alameda Science and Technology Institute"
STATE = "CA"
BASE_URL = "https://asti-alamedausd-ca.schoolloop.com"
...
async def scrape_school() -> dict[str, Any]:
    """Visit ASTI's public School Loop URLs and record blocked-access evidence."""
    ...
    if page_signals and len(blocked_page_urls) == len(page_signals):
        blocked_reason = (
            "ASTI's public School Loop pages resolved only to 403 Forbidden Cloudflare responses "
            "through the required Oxylabs proxy session, so public athletics content could not be verified."
        )
        errors.append(
